...
<head>
    ...
    <!-- Favicon -->
    <link href="{{ asset('homepagetamplate/assets/images/ukk2.png') }}" rel="icon" type="image/png">
...
<body id="page-top">
    ...
    <div id="wrapper">
        <!-- Sidebar -->
        <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: #0084ffef;">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Ferdy;2023</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
