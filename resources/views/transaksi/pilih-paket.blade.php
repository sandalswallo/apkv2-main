                            ...
                            <div class="col-md-4 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" style=" border-bottom: 2px solid black;"
                                        ...
                                        name="biaya_tambahan" id="biaya_tambahan" placeholder="masukkan biaya tambahan"
                            ...
                            <div class="col-md-4 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" style=" border-bottom: 2px solid black;"
                                        ...
                                        id="pajak" placeholder="masukkan pajak" autocomplete="off"
                                        value="{{ old('pajak') }}">
                                    @error('pajak')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="col-md-4 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" style=" border-bottom: 2px solid black;"
                                        ...
                                        id="diskon" placeholder="masukkan diskon" autocomplete="off"
                                        value="{{ old('diskon') }}">
                                    @error('diskon')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
